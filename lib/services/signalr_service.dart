...
class SignalRService {
  ...
  late final Logger _logger = Logger('BeluCar.Admin.SignalR');
  ...
  void ensureConnection({required String hubUrl, required String accessToken}) {
  ...
  Future<void> connect({
    ...
    ensureConnection(hubUrl: hubUrl, accessToken: accessToken);
