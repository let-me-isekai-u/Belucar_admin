...
class StatusFourScreen extends StatefulWidget {
  ...
  @override
  State<StatusFourScreen> createState() => _StatusFourScreenState();
}

class _StatusFourScreenState extends State<StatusFourScreen> {
  ...
  Future<void> _loadData({bool isRefresh = false}) async {
    ...
    try {
      ...
      final response = await ApiService.getCompletedRides(
        accessToken: token,
        page: _currentPage,
        pageSize: 15,
      );
      ...
      debugPrint("Lỗi tải đơn hàng Status 4: $e");
    } finally {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Chuyến đã hoàn thành"),
      ...
      body: RefreshIndicator(
        ...
        child: _isLoading && _allRides.isEmpty
            ...
            : _allRides.isEmpty
            ? const Center(child: Text("Chưa có chuyến xe nào hoàn thành"))
            : ListView.builder(
